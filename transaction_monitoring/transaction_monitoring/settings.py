...
# run celery beat: celery -A transaction_monitoring beat -l info . and . celery -A transaction_monitoring worker -l info
...
SECRET_KEY = "django-insecure-p2ivq^3ex8%a4#rt+bt9w+sudx_#ast)fz7cp&17p5vcn7869y"
